...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeHero.Models.ComplaintUser", b =>
                {
                    b.Property<int>("ComplaintUserID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ComplaintUserID"));

                    b.Property<int>("AttenderComplaintID")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UnsatisfiedComplaintID")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ComplaintUserID");

                    b.HasIndex("AttenderComplaintID");
                    ...
                    b.HasIndex("UnsatisfiedComplaintID");
            ...
            modelBuilder.Entity("HomeHero.Models.ComplaintUser", b =>
                {
                    b.HasOne("HomeHero.Models.Complaint", "AttenderComplaint")
                        .WithMany()
                        .HasForeignKey("AttenderComplaintID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("HomeHero.Models.Complaint", null)
                        .WithMany("UnsatisfiedComplaint")
                        .HasForeignKey("ComplaintID");

                    b.HasOne("HomeHero.Models.Complaint", null)
                        .WithMany("AttenderComplaint")
                        .HasForeignKey("ComplaintID1");

                    b.HasOne("HomeHero.Models.Complaint", "UnsatisfiedComplaint")
                        .WithMany()
                        .HasForeignKey("UnsatisfiedComplaintID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("AttenderComplaint");

                    b.Navigation("AttenderUser");

                    b.Navigation("UnsatisfiedComplaint");
